...
bot_token = '7835150372:AAFl75GfTYAMwkzmQv9-VzI254zpTWyDdks'
bot = telebot.TeleBot(bot_token)
user_data = {}
allowed_users = ['7098909873]
admin_id = '7098909873,7451695607'
subscription_data = {}
...
def start(message):
    ...
    if user_id in allowed_users:
        ...
        bot.reply_to(message, 'welcome to the Spam Mail bot                                                       Dev : @mmmooooo33 , l_Llll12', reply_markup=keyboard)
    else:
        bot.reply_to(message, 'البوت مجاني يرجى إرسال أيديك هنا للتفعيل                                        - @mmmooooo33 , l_Llll12')
...
def show_admin_commands(message):
    if message.from_user.id == 7098909873:  # تم تعديل هذا السطر
